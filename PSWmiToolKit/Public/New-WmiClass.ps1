...
.EXAMPLE
    "Key = $true `n Static = $true `n Description = MEMZone Blog" | New-WmiClass -Namespace 'ROOT' -ClassName 'MEMZone'
.EXAMPLE
    New-WmiClass -Namespace 'ROOT\ConfigMgr' -ClassName 'MEMZone' -CreateDestination
.NOTES
