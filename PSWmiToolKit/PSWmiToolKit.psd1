...
@{
    ...
    FormatsToProcess = @('PSWmiToolkit.Format.ps1xml')
    ...
    FileList = @('PSWmiToolKit.psm1', 'PSWmiToolKit.psd1', 'PSWmiToolKit.Format.ps1xml')
    ...
    HelpInfoURI = 'https://github.com/JhonnyTerminus/PSWmiToolKit/blob/master/PSWmiToolKit/en-US/PSWmiToolkit-help.xml'
